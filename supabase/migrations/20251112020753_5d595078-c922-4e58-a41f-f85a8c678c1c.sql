...
DROP POLICY IF EXISTS "Users can view their own bug report screenshots" ON storage.objects;
DROP POLICY IF EXISTS "Admins can view all bug report screenshots" ON storage.objects;
...
-- Inserir configuração padrão se ainda não existir
...
-- Remover políticas antigas de app_settings
